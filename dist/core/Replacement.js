...
var _SetText2 = _interopRequireDefault(require("./SetText.js"));
...
var Replacement = /*#__PURE__*/function (_SetText) {
  _inherits(Replacement, _SetText);

  var _super = _createSuper(Replacement);
  ...
  _createClass(Replacement, [{
    key: "in",
    value: function _in(tmp) {
      var _replaceFunc = (0, _encryption.replaceFunc)(tmp),
          replacement = _replaceFunc.replacement,
          txt1 = _replaceFunc.txt1;
